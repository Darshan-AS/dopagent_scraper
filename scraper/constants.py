...
class ReportsPage:
    ...
    INSTALLMENT_REFERENCE_NUMBER_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.EBANKING_REF_NUMBER_ARRAY'
    INSTALLMENT_ACCOUNT_NUMBER_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.SAVED_ACCOUNT_NUMBER_ARRAY'
    INSTALLMENT_TOTAL_DEPOSIT_AMOUNT_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.SAVED_RD_INSTALLMENT_AMOUNT_ARRAY'
    INSTALLMENT_NUMBER_OF_INSTALLMENTS_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.NO_OF_INSTALLMENT_ARRAY'
    INSTALLMENT_REBATE_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.RD_REBATE_ARRAY'
    INSTALLMENT_DEFAULT_FEE_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.RD_DEFAUT_FEE_ARRAY'
    INSTALLMENT_STATUS_ID_PREFIX = 'CustomAgentRDAccountFG.INSTALLMENT_STATUS_ARRAY'
    INSTALLMENT_LAST_CREATED_DATE_AND_TIME_ID_PREFIX = 'HREF_CustomAgentRDAccountFG.LAST_CREATE_DATE_ARRAY'
